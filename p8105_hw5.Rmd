...
The dataset pulled from the _Washington Post_ has **`r nrow(homicide)`** observations across **`r ncol(homicide)`** variables that include information about the location of the homicide and the victim (first and last name, age, sex, race).  
